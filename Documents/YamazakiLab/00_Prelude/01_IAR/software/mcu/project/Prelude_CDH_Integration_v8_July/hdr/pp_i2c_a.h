...
#define FUNCSEL3 03
//*** I2C
#define I2CA_CLKSCALE_VAL 0x0018    // default to normal mode, divide by 25 for 50 MHz SysClk 
#define I2C_START_STOP_CMD 0x03     // start with stop 

/* main function */
extern void I2CA_TC(uint8_t* I2C_DATA_TX, uint8_t I2C_WORDS_TX);
extern void I2CA_TLM(uint8_t* I2C_DATA_RX, uint8_t* I2C_DATA_TX, uint8_t I2C_WORDS_RX);
/* detail function */
extern uint32_t init_i2ca() ;
extern void i2ca_read(uint8_t* I2C_DATA, uint8_t I2C_WORDS);
extern void i2ca_write(uint8_t* I2C_DATA, uint8_t I2C_WORDS);
